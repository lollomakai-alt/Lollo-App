...
function MappaLive() {
  ...
  const handleTap = useCallback(
    async (id: string) => {
      ...
      setActiveOrderTable({ id: String(targetTable.id), label: targetTable.label, seats: targetTable.seats });
    },
            ...
            >
              ...
              {isLoading ? (
                ...
                <div className="h-full w-full flex items-center justify-center p-4">
                  ...
                  >
                    {tables.map((t) => {
                      const courseInfo = t.status === "occupied" ? tableCourseInfo(String(t.id)) : { statusOverride: undefined, alert: false };
                      return (
                        <TableCard
                          key={t.id}
                          table={t}
